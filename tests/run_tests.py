...
def run_tests():
    ...
    if TEST_ALL:
        ...
        tests_eq = {       #    test_fn    |        test_args        |  wanted result
            ...
            'encode_file_X_A': (encode_file_and_read, (rle.RLEMethod.A, 'dadosX.bin'), rle_C1),
            'encode_file_X_B': (encode_file_and_read, (rle.RLEMethod.B, 'dadosX.bin'), rle_C2),
            'encode_file_Y_A': (encode_file_and_read, (rle.RLEMethod.A, 'dadosY.bin'), rle_D1),
            'encode_file_Y_B': (encode_file_and_read, (rle.RLEMethod.B, 'dadosY.bin'), rle_D2),
            'encode_file_Z_A': (encode_file_and_read, (rle.RLEMethod.A, 'dadosZ.bin'), rle_E1),
            'encode_file_Z_B': (encode_file_and_read, (rle.RLEMethod.B, 'dadosZ.bin'), rle_E2),
